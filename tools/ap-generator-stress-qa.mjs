...
for(const spec of specs){
  ...
  for(const category of spec.categories){
    ...
    const fakeDocument={getElementById:id=>elements[id]||(elements[id]=elem()),createElement:()=>elem(),addEventListener(){},querySelector(){return null;},querySelectorAll(){return[];}};
